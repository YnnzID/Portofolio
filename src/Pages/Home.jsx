...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/YnnzID", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/YnnzID/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/YnnzID_/?hl=id", label: "Instagram Profile" }
];
  ...
  useEffect(() => {
    async function fetchProfile() {
      try {
        ...
        if (data) {
          setProfile({
            name: data.name || 'YnnzID',
            bio: data.bio || 'Menciptakan Website Yang Inovatif, Fungsional, dan User-Friendly untuk Solusi Digital.',
            avatar_url: data.avatar_url || 'Animation1.gif'
          })
        }
      } catch (error) {
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": [
              "https://github.com/YnnzID",
              "https://www.linkedin.com/in/YnnzID/",
              "https://www.instagram.com/YnnzID_/"
            ]
          }
        `}</script>
      </Helmet>
